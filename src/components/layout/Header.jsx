    ...
    <header className="sticky top-0 z-10 bg-white dark:bg-dark-surface border-b border-slate-200 dark:border-dark-border">
        <div className="flex items-center justify-between px-4 h-16">
            ...
            <div className="flex items-center space-x-4">
                ...
                <div className="flex items-center space-x-3 bg-slate-50 dark:bg-slate-700 px-3 py-1.5 rounded-full border border-slate-100 dark:border-slate-600">
                    <div className="relative flex h-3 w-3">
                        <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-red-400 opacity-75"></span>
                        <span className="relative inline-flex rounded-full h-3 w-3 bg-red-500"></span>
                    </div>
                    <div className="flex flex-col leading-none">
                        <span className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest">System Live</span>
                        <span className="text-[10px] font-medium text-slate-400 dark:text-slate-500">Sync: 2s ago</span>
                    </div>
            ...
            <div className="hidden md:flex items-center space-x-6">
                <div className="flex items-center space-x-2">
                    <span className="text-2xl font-bold text-slate-700 dark:text-dark-text">{stats.active}</span>
                    <span className="text-[10px] font-bold text-slate-400 dark:text-dark-text-muted uppercase leading-tight">Active<br/>Incidents</span>
                </div>
                <div className="w-px h-8 bg-slate-100 dark:bg-slate-600"></div>
                <div className="flex items-center space-x-2">
            ...
            <div className="flex items-center space-x-3">
                ...
                <div className="relative cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-700 p-2 rounded-full transition-colors group">
                ...
                {currentUser && (
                    <button 
                        onClick={logout}
                        className="text-[10px] font-bold text-slate-400 dark:text-dark-text-muted hover:text-red-500 ml-2 uppercase tracking-wider"
                    >
                        Logout
                    </button>
                )}
